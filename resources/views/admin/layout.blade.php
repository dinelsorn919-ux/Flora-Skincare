        ...
        <aside class="w-64 bg-white border-r border-line px-6 py-8 flex flex-col justify-between flex-shrink-0 shadow-sm">
            <div>
                ...
                <nav class="space-y-1.5 text-xs font-medium">
                    ...
                    <!-- Users Link -->
                    <a href="{{ route('admin.users.index') }}" class="flex items-center gap-3 px-3.5 py-3 rounded-xl transition-all {{ request()->routeIs('admin.users*') ? 'bg-forest text-bone shadow-md' : 'text-ink/80 hover:bg-forest/5' }}">
                    <svg class="w-4 h-4 opacity-80" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z"/></svg>
                    Users
                    </a>
                </nav>
            </div>
